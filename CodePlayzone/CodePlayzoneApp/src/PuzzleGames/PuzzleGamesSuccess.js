...
const PuzzleGamesSuccess = ({ navigation }) => {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Congratulations</Text>
      <Text style={styles.subtitle}>You have completed all the puzzles!</Text>
      ...
      <TouchableOpacity style={styles.navigateButton} onPress={() => navigation.navigate('QuizScreen')}>
      ...
      >
        <Text style={styles.buttonText}>RESTART PUZZLE GAMES</Text>
      </TouchableOpacity>
    </View>
  );
};
...
export default PuzzleGamesSuccess;
