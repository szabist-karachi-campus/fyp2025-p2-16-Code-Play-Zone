...
// const PuzzleGame1PS = ({ navigation }) => {
//   const initialPositionsPlain = {
//     '("123")': { x: 10, y: 10 },
//     'sum': { x: 110, y: 10 },
//     'print': { x: 210, y: 10 },
//     '("Welcome to Code PlayZone!")': { x: 310, y: 10 },
//   };
...
//     ['print', '("Welcome to Code PlayZone!")']
//   ];
...
//             },
//             body: JSON.stringify({ progress_item: 'Puzzle Level 1 Completed' }),
//           });
...
//             navigation.navigate('PuzzleGame2Variables');
//           } else {
...
//       <Text style={styles.header}>Print Statements</Text>
//       <Text style={styles.objective}>Objective</Text>
//       <Text style={styles.instruction}>
//         Drag and arrange blocks to print "Welcome to Code PlayZone!"
//       </Text>
...
//             key={index}
//             style={[
//               blockPositions[blockText].getLayout(),
...
//   //   position: 'absolute',
//   //   width: 80,
//   //   height: 80, // Same width and height
//   //   backgroundColor: '#f0ad4e',
...
//   //   position: 'absolute',
//   //   width: 120,
//   //   height: 60, // Different width and height
//   //   backgroundColor: '#f0ad4e',
//   //   borderRadius: 15, // Smaller radius for rounded corners
//   //   justifyContent: 'center',
//   //   alignItems: 'center',
//   // },
//   blockText: {
...
const PuzzleGame1PS = ({ navigation }) => {
  ...
  const requiredBlocksOptions = [['print', '("Welcome to Code PlayZone!")']];
    ...
    try {
      ...
      if (isSolutionCorrect) {
        ...
        const progressResponse = await fetch('http://10.0.2.2:8000/api/game/progress/add', {
          ...
          body: JSON.stringify({ progress_item: 'Puzzle Level 1 Completed', points }),
        });
  ...
  const handleSkip = () => {
    Alert.alert("Confirm Skip", "Do you want to skip this level or game?", [
      { text: "Cancel", style: "cancel" },
      { text: "Level", onPress: () => navigation.navigate("PuzzleGame2Variables") },
  ...
  return (
    <View style={styles.container}>
      ...
      {showPoints && (
        <Animated.View style={[styles.pointsBubble, { opacity: fadeAnim }]}>
          <Text style={styles.pointsText}>+{pointsEarned} Points!</Text>
        </Animated.View>
      )}

      <View style={styles.buttonContainer}>
        <Text style={styles.checkButton} onPress={handleCheck}>CHECK</Text>
        <Text style={styles.resetButton} onPress={handleReset}>RESET</Text>
