...
// const PuzzleGame3AO = ({ navigation }) => {
...
//             },
//             body: JSON.stringify({ progress_item: 'Puzzle Level 3 Completed' }),
//           });
...
//             navigation.navigate('PuzzleGame4CS');
//           } else {
...
//       <Text style={styles.header}>Arithmetic Operations</Text>
//       <Text style={styles.objective}>Objective</Text>
//       <Text style={styles.instruction}>
//       Drag and arrange blocks to calculate the sum of two numbers and print the result.
//       </Text>
...
const PuzzleGame3AO = ({ navigation }) => {
    ...
    try {
      ...
      if (isSolutionCorrect) {
        ...
        const progressResponse = await fetch('http://10.0.2.2:8000/api/game/progress/add', {
          ...
          body: JSON.stringify({ progress_item: 'Puzzle Level 3 Completed', points }),
        });
  ...
  const handleSkip = () => {
        Alert.alert("Confirm Skip", "Do you want to skip this level or game?", [
          { text: "Cancel", style: "cancel" },
          { text: "Level", onPress: () => navigation.navigate("PuzzleGame4CS") },
    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
              ...
              <Text style={styles.resetButton} onPress={handleReset}>
               ...
               <Text style={styles.resetButton} onPress={handleSkip}>
                SKIP</Text>
              <Text style={styles.exitButton} onPress={handleExit}>
                EXIT
              </Text>
