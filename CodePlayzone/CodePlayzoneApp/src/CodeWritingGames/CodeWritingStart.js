...
export default function CodeWritingStart({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      {/* Title */}
      <Text style={styles.title}>Code Writing Game</Text>

      {/* Puzzle Image */}
      <Image
        source={require('../../pictures/codelogo.jpg')}
        style={styles.image}
      />
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={() => navigation.navigate('CodeWritingScreen')}
      >
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('QuizGamesSuccess')}
      >
        <Text style={styles.buttonText}>BACK</Text>
      </TouchableOpacity>
      <TouchableOpacity
        style={styles.button} // Back button with same styling as "LET'S GO" button
        onPress={() => navigation.navigate('CodeWritingGamesSuccess')}
      >
