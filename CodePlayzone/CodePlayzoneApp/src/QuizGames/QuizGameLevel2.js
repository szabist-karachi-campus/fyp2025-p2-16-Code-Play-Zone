...
//   },
//   {
//     question: 'Which statement about code is correct?',
//     options: [' Code is written to instruct computers', ' Code is only used for video games', 'Code is the same as a text document'],
//     correctAnswer: 0,
//   }
// ];

// const QuizGameLevel2 = () => {
...
//       Alert.alert('Level 2 Completed', `Your score: ${score + (optionIndex === questions[questionIndex].correctAnswer ? 1 : 0)}`, [
//         { text: 'Next Level', onPress: () => navigation.navigate('QuizGameLevel3') }
//       ]);
//     }
//   };
...
//         </View>
//         <Text style={styles.levelTitle}>Level 2: Understanding Programs and Code</Text>
...
const questions = [
  ...
  },
  {
    question: 'Which statement about code is correct?',
    options: [
      ' Code is written to instruct computers',
      ' Code is only used for video games',
      'Code is the same as a text document'
    ],
    correctAnswer: 0,
  }
];
      ...
      try {
        ...
        if (authToken) {
          const response = await fetch('http://10.0.2.2:8000/api/game/progress/add', {
            ...
            body: JSON.stringify({
              progress_item: 'Quiz Level 2 Completed',
              points: finalPoints,
            }),
          });
  ...
  const handleSkip = () => {
    Alert.alert(
      ...
      [
        ...
        { text: "Level", onPress: () => navigation.navigate("QuizGameLevel3") },
