...
//       Alert.alert('Level 5 Completed', `Your score: ${score + (optionIndex === questions[questionIndex].correctAnswer ? 1 : 0)}`, [
//         { text: 'Next Level', onPress: () => navigation.navigate('QuizGameLevel6') }
//       ]);
//     }
//   };
...
//         </View>
//         <Text style={styles.levelTitle}>Level 5: Variables and Arithmetic Operators</Text>
      ...
      try {
        ...
        if (authToken) {
          const response = await fetch('http://10.0.2.2:8000/api/game/progress/add', {
            ...
            body: JSON.stringify({
              progress_item: 'Quiz Level 5 Completed',
              points: finalPoints,
            }),
          });
  ...
  const handleSkip = () => {
    Alert.alert(
      ...
      [
        ...
        { text: "Level", onPress: () => navigation.navigate("QuizGameLevel6") },
