...
// const questions = [
//   {
//     question: 'Which function is used to display text on the screen in Python?',
//     options: [
//       'print()',
//       'display()',
//       'show()'
...
//       Alert.alert('Level 4 Completed', `Your score: ${score + (optionIndex === questions[questionIndex].correctAnswer ? 1 : 0)}`, [
//         { text: 'Next Level', onPress: () => navigation.navigate('QuizGameLevel5') }
//       ]);
//     }
//   };
...
//         </View>
//         <Text style={styles.levelTitle}>Level 4: Print Statements</Text>
      ...
      try {
        ...
        if (authToken) {
          const response = await fetch('http://10.0.2.2:8000/api/game/progress/add', {
            ...
            body: JSON.stringify({
              progress_item: 'Quiz Level 4 Completed',
              points: finalPoints,
            }),
          });
  ...
  const handleSkip = () => {
    Alert.alert(
      ...
      [
        ...
        { text: "Level", onPress: () => navigation.navigate("QuizGameLevel5") },
