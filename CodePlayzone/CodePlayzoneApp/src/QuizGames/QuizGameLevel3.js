...
//       Alert.alert('Level 3 Completed', `Your score: ${score + (optionIndex === questions[questionIndex].correctAnswer ? 1 : 0)}`, [
//         { text: 'Next Level', onPress: () => navigation.navigate('QuizGameLevel4') }
//       ]);
//     }
//   };
...
//         </View>
//         <Text style={styles.levelTitle}>Level 3: Syntax and Error Identification</Text>
      ...
      try {
        ...
        if (authToken) {
          const response = await fetch('http://10.0.2.2:8000/api/game/progress/add', {
            ...
            body: JSON.stringify({
              progress_item: 'Quiz Level 3 Completed',
              points: finalPoints,
            }),
          });
  ...
  const handleSkip = () => {
    Alert.alert(
      ...
      [
        ...
        { text: "Level", onPress: () => navigation.navigate("QuizGameLevel4") },
